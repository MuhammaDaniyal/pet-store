...
export default async function AdminVetsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      <div className="mb-8">
        <h1 className="text-[clamp(1.8rem,3vw,2.6rem)] font-semibold tracking-[-0.04em] text-primary">Vets Management</h1>
        <p className="mt-3 text-base text-secondary">Manage and verify veterinarian profiles across the platform.</p>
      </div>
        ...
        <table className="w-full text-left whitespace-nowrap">
          <thead className="border-b border-border bg-background/50">
            <tr>
              ...
              <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-muted">Email</th>
              <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-muted">Specialization</th>
              <th className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-muted">Fee</th>
