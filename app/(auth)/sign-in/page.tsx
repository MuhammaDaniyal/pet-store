  ...
  return (
    <section className="w-full max-w-md rounded-[16px] border border-[#D6D4CE] bg-[#EDECE8] p-10">
      <div className="space-y-2">
        <h1 className="text-2xl font-medium text-[#0A0A0A]">Welcome back</h1>
        <p className="text-sm text-[#4A4945]">Sign in to your account</p>
      </div>
      ...
      <p className="mt-6 text-sm text-[#8A8880]">
        ...
        <Link href="/sign-up" className="font-medium text-[#0A0A0A] underline-offset-4 hover:underline">
          Sign up
        </Link>
      </p>
    </section>
